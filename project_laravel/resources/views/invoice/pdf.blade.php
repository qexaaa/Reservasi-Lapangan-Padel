...
<head>
    <meta charset="utf-8">
    <title>Invoice {{ $reservasi->invoice_number }}</title>
...
<div class="box">
    <p><strong>No Invoice:</strong> {{ $reservasi->invoice_number }}</p>
    <p><strong>Nama Customer:</strong> {{ $reservasi->user->name }}</p>
    ...
    <p>
        ...
        @elseif($reservasi->status_pembayaran === 'waiting_verification')
