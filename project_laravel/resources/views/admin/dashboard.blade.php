...
<div class="container">
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-0">{{ $menungguVerifikasi  }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-0">{{ $reservasiTerverifikasi }}</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <a href="{{ route('admin.verifikasi.index') }}" class="text-decoration-none text-dark">
                <div class="card shadow-sm border-0 h-100 hover-card">
                    <div class="card-body text-center">
         ...
         <div class="col-md-4 mb-3">
            <a href="{{ route('admin.invoice.index') }}" class="text-decoration-none text-dark">
                <div class="card shadow-sm border-0 h-100 hover-card">
                    <div class="card-body text-center">
        ...
        <div class="col-md-4 mb-3">
            <a href="{{ route('admin.laporan.index') }}" class="text-decoration-none text-dark">
                <div class="card shadow-sm border-0 h-100 hover-card">
                    <div class="card-body text-center">
